...
![Cross-section of a camera module: lens, aperture, shutter, color filter array and image sensor](images/01-camera-sensor-parts.png)
...
![ISP pipeline stages from black level correction through demosaic to YUV output](images/02-isp-pipeline.png)
...
![camera pipeline](images/camera_pipeline.png)

#### PINOUT for MIPI CSI-2 interface
![MIPI CSI-2 pinout](images/mipi_csi2_pinout.png)
...
![Lane states](images/Lane_states_description.png)

### FRAME TIMINGS : 
![FRAME Seq ](images/Digital_display_sync_relationship.png)
...
![FRAME TIMINGS ](images/Vertical_Horizontal_Timing.png)
