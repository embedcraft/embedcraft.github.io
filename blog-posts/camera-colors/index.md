...
![Bayer RGGB mosaic: each pixel is filtered to one of R, G, G, B; the 2x2 tile has two greens](images/color-raw-bayer.png)
...
![RGB bit allocation: RGB888 = 24 bpp down to RGB444 = 12 bpp; RGB565 gives green the extra bit](images/color-rgb-packing.png)
...
![YUV chroma subsampling: 4:4:4 keeps chroma on every pixel, 4:2:2 halves it horizontally, 4:2:0 quarters it](images/color-yuv-subsampling.png)
