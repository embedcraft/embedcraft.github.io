...
Everything here traces back to the *OV5640 datasheet, product specification version
2.03, may 2011*. Section numbers in parentheses are datasheet sections.

Companion files, available as downloads:

| File | What it is |
|---|---|
| [`NOTES.md`](files/NOTES.md) | gotchas, pin tables and the worked calculations |
| [`ov5640.h`](files/ov5640.h) | driver public API + register map |
| [`ov5640.c`](files/ov5640.c) | driver implementation + register tables |
...
- OV5640 datasheet — product specification v2.03, may 2011
